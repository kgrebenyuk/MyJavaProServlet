...
//
//        employee.setName("oleg11");
//        employee.setEmail("11 ");
//        employee.setCountry(" 111");
//        save(employee);
//    }
...
//        String password = "5";
    ...
    public static int myUpdateEmailById(int id, String newEmail) {
        int status = 0;
        Connection connection = EmployeeRepository.getConnection();
        try {
            ...
            System.out.println("myUpdateEmailById is Nok");
        }
        return status;
    }

    public static List<Employee> myGetByCountry(String country) {
        List<Employee> listEmployees = new ArrayList<>();

        try {
            Connection connection = EmployeeRepository.getConnection();
            PreparedStatement ps = connection.prepareStatement("select * from users where country=?");
            ...
            System.out.println("myGetByCountry is Nok");
        }
